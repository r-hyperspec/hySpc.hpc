...
2.  **Rust**: A highly optimized Rust backend leveraging self-contained `csc_matvec` Krylov kernels, `faer` sparse factorizations, and `rayon` for parallel processing.
